    ...
    <div className='home'>
      ...
      <div className='nav_header_home'>
        <ul className='ul_header_home'>
          ...
          <li style={{ fontFamily: 'Roboto', fontWeight: 600, color: `${headerLink === 'Combos' ? 'blue' : 'black'}` }} onClick={Combos} className='li_header_home'>Combos marinos</li>
